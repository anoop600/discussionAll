package com.mindtree.diccussionMVC.bean;
...
public class FactoryMethod {
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		sessionFactory.setAnnotatedClasses(Genre.class, Actor.class, Movie.class);
		sessionFactory.setPackagesToScan("com.mindtree");
